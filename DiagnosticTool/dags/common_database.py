...
#opeartor to check bloating in the database and analysis the database
opr_check_bloating_and_analyze = SaltOperator(
    task_id='check_bloating_and_analyze',
    module_name='bloating_and_analyze_wrapper.bloating_and_analyze_caller', #to invoke the function of bloating and analyze db
    provide_context = True,
    execution_timeout = DEFAULT_EXECUTION_TIMEOUT,
    retries = DEFAULT_RETRIES,
    retry_delay = DEFAULT_RETRY_DELAY,
...
opr_check_blocking_and_deadlock >> opr_check_idle_and_running_state >> opr_check_long_running_queries >> opr_check_bloating_and_analyze
